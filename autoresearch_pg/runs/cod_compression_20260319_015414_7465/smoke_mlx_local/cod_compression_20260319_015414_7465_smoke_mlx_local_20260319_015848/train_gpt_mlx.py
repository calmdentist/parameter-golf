...
class SplitOptimizers:
    ...
    def step(self, model: GPT, grads_tree: dict, step: int, lr_mul: float, matrix_lr_mul: float) -> None:
        params = dict(tree_flatten(model.parameters()))
...
def main() -> None:
    ...
    while True:
        ...
        matrix_lr_mul = args.matrix_lr_mul(lr_mul)
        ...
        opt.step(model, grads, step=step, lr_mul=lr_mul, matrix_lr_mul=matrix_lr_mul)
        mx.synchronize()
